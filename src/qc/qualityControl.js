class ImageDataService {
  constructor() {
    ...
    this.staticImages = [
      { id: "image1", url: "../../data/test.png", votes: 0 }, // need a way to aggregate total votes
      { id: "image2", url: "../../data/test.png", votes: 0 },
      { id: "image3", url: "../../data/test.png", votes: 0 },
      { id: "image4", url: "../../data/test.png", votes: 0 },
      { id: "image5", url: "../../data/test.png", votes: 0 },
    ];
  }
